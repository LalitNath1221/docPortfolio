        ...
        <div>
            <section className="">
                <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
                    ...
                    <div className="flex flex-col text-lg text-gray-700 sm:px-8 lg:px-12 xl:px-32">
                        <details className='border-b-2 border-b-gray-700'>
                            <summary className="py-2 outline-none cursor-pointer focus:outline-none">Optio maiores eligendi molestiae totam dolores similique?</summary>
                        ...
                        <details className='border-b-2 border-b-gray-700'>
                            <summary className="py-2 outline-none cursor-pointer focus:outline-none">Modi dolorem veritatis culpa quos consequuntur beatae itaque excepturi perspiciatis?</summary>
                            <div className="px-4 pb-4">
                        ...
                        <details className='border-b-2 border-b-gray-700'>
                            <summary className="py-2 outline-none cursor-pointer focus:outline-none">Magni reprehenderit possimus debitis?</summary>
